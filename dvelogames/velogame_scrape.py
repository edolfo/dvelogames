...
BASE_URL = "https://www.velogames.com/velogame/2024/leaguescores.php?league=14808756&ga=13&st="
STAGES = range(1, 15)
SLEEPY_TIME = 1  # Since velogames does not offer an API this value is quite relaxed
RESULTS_FILE = 'results.json'


def results_2_soup(stage: int) -> dict[str, str]:
...
def soup_2_users(soup: bs4.BeautifulSoup) -> bs4.element.Tag:
    return list(soup.find(id='users').children)[1]  # 0 and 2 are newlines
